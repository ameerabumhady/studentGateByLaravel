...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="/home">Students Gate</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseStudents" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/displayStudents">Display Students</a>
                            ...
                            <div class="collapse" id="collapseCourses" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/displayCourses">Display Courses</a>
                            ...
                            <div class="collapse" id="collapseColleges" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/displayColleges">Display Colleges</a>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li >Quiqe Links  ></li> <pre>  </pre>
                            <li class=""><a href="/displayStudents">Students</a></li> <pre> | </pre>
                            <li class=""><a href="/displayCourses">Courses</a></li> <pre> | </pre>
                            <li class=""><a href="/displayColleges">Colleges</a></li> <pre> | </pre>
                            <li class=""><a href="/studentGrades">Grades</a></li>
                        </ol>
